...
# Agregar todos los archivos y carpetas, excluyendo los que están en .gitignore
system("git add .", intern = TRUE)

# Realizar el commit con comillas dobles para evitar problemas con los espacios
...
system("git pull origin main", intern = TRUE)  # Cambia "main" si tu rama principal tiene otro nombre

# Hacer push a la rama principal
system("git push -u origin main", intern = TRUE)  # Cambia "main" si tu rama principal tiene otro nombre
```
